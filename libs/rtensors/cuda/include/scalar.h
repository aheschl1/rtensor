...
void launch_flat_contiguous_reduce_argmax_f64(const double *data, uint32_t *out, size_t start, size_t len, ReductionOpCode code, ReductionSettings *settings, unsigned int block_size);
