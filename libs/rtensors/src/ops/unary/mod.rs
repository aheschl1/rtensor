...
macro_rules! specify_unary_op_template {
    (
        $(
            ($name:ident) $op:ident $(where T: $first:path $(, $extra:path)*)?; |$tensor:ident, $result:ident, $ctx:ident, $grad_node:ident| $grad_fn:block
        ),+ $(,)?
    ) => {
